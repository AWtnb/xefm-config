...
import platform  # noqa: F401, I001
import sys

# Import xefm_tool function and xefm_python variable for external program configuration
from xefm.external_programs import xefm_tool, xefm_python  # ty: ignore[unresolved-import]
...
class Config:
    ...
    KEY_BINDINGS = {  # noqa: RUF012
        ...
        "image_viewer.zoom_reset": [
            "0"
        ],  # Image viewer: fit the whole image to the window
